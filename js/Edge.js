define("js/Edge", ["three"], function(Three) {
    ...
    const GOOD = new Three.LineBasicMaterial({color: 0x00FF00});
    const BAD  = new Three.LineBasicMaterial({color: 0xFF0000});
    ...
    class Edge {
        ...
        constructor(p1, p2, length) {
            ...
            this.mGeometry.vertices.push(p1.current);
            this.mGeometry.vertices.push(p2.current);
            this.mSatisfied = false;
            this.line = new Three.Line(this.mGeometry, GOOD);
        }
