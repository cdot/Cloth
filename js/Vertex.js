...
const LOCKED   = new MeshBasicMaterial({color: 0xFFFF00});
const UNLOCKED = new MeshBasicMaterial({color: 0x0000FF});
...
class Vertex {
  ...
  constructor(id, v) {
    ...
    this.mEdges = [];
    this.mGeometry = new BoxGeometry(10, 10, 10);
    this.mLocked = false;
    this.marker = new Mesh(this.mGeometry, UNLOCKED);
  }
